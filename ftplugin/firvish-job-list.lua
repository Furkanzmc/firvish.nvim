...
map("n", "R", ":lua require'firvish.job_control'.refresh_job_list_window()<CR>", { silent = true, buffer = bufnr })
...
map("n", "S", ":lua require'firvish.job_control'.stop_job()<CR>", { silent = true, buffer = bufnr })
